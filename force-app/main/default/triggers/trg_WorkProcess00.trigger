/* Trigger for Work Process 00 */
trigger trg_WorkProcess00 on Project_Risk_Assessment__c (after update) {
    ...
    if(Trigger.IsAfter && Trigger.IsUpdate) {
        ...
        Master_Data_Detail__c WP = [select id, name, Work_Process_No__c from Master_Data_Detail__c where Work_Process_No__c =: 0];
        
        if(rtName == 'Step 00 : Before Submit' && waitingForApprove) {
        ...
        else if(rtName == 'Step 00 : After Submit') {
