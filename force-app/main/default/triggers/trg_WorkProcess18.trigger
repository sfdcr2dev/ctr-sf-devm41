/* Trigger for Work Process 18 */
trigger trg_WorkProcess18 on ITB_Standard_18__c (before update, after update) {
    ...
    if(Trigger.IsBefore && Trigger.IsUpdate) {
        ...
        CPEM_AllWorkProcessForTriggerController.UpdateWorkProcess18Status(Trigger.Old[0].SME__c, Trigger.New[0].SME__c, Trigger.New[0].Project__c, Trigger.New[0]);
    ...
    if(Trigger.IsAfter && Trigger.IsUpdate) {
        ...
        Master_Data_Detail__c WP = [select id, name, Work_Process_No__c from Master_Data_Detail__c where Work_Process_No__c =: 18];
        
        if(rtName == 'Step 18 : Before Submit' && waitingForApprove) {
        ...
        else if(rtName == 'Step 18 : After Submit') {
