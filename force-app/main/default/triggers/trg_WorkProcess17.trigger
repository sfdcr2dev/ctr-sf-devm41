/* Trigger for Work Process 17 */
trigger trg_WorkProcess17 on Engineering_Data_Book_and_3D_Model__c (before update, after update) {
    ...
    if(Trigger.IsBefore && Trigger.IsUpdate) {
        ...
        CPEM_AllWorkProcessForTriggerController.UpdateWorkProcess17Status(Trigger.Old[0].SME__c, Trigger.New[0].SME__c, Trigger.New[0].Project__c, Trigger.Old[0], Trigger.New[0]);
    ...
    if(Trigger.IsAfter && Trigger.IsUpdate) {
        ...
        Master_Data_Detail__c WP = [select id, name, Work_Process_No__c from Master_Data_Detail__c where Work_Process_No__c =: 17];
        
        if(rtName == 'Step 17 : Before Submit' && waitingForApprove) {
        ...
        else if(rtName == 'Step 17 : After Submit') {
