/* Trigger for Work Process 4 */
trigger trg_WorkProcess4 on Project_Execution_Plan__c (before update, after update) {
    ...
    if(Trigger.IsBefore && Trigger.IsUpdate) {
        ...
        CPEM_AllWorkProcessForTriggerController.UpdateWorkProcess4Status(Trigger.Old[0].SME__c, Trigger.New[0].SME__c, Trigger.New[0].Project__c, Trigger.New[0]);
    ...
    if(Trigger.IsAfter && Trigger.IsUpdate) {
        ...
        Master_Data_Detail__c WP = [select id, name, Work_Process_No__c from Master_Data_Detail__c where Work_Process_No__c =: 4];
        
        if(rtName == 'Step 4 : Before Submit' && waitingForApprove) {
        ...
        else if(rtName == 'Step 4 : After Submit') {
        ...
        CPEM_AllWorkProcessForTriggerController.UpdateFromServiceRequisition(Trigger.Old[0].SME__c, Trigger.New[0].SME__c, Trigger.New[0].Project__c, Trigger.New[0]);
