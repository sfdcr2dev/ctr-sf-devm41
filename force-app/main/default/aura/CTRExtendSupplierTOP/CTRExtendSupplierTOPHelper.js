    ...
    getFormData: function(component) {
        ...
        return {
            ...
            CTRRequestFormItem__c: {
                ...
                InterestedProductTypeAsSupplierTOP__c: component.find('InterestedProductTypeAsSupplierTOP__c').get('v.value'),
                PetroleumAndComponentsProducts__c: component.find('PetroleumAndComponentsProducts__c').get('v.value'),
                SupplierProductIdentification__c: component.find('SupplierProductIdentification__c').get('v.value'),
                PurchasingOrganization__c: component.find('PurchasingOrganization__c').get('v.value'),
