({
    doInit: function (component, event, helper) {
        ...
        console.log('recordId123--initial--' + recordId);
            ...
            try {
                ...
                action.setCallback(this, function (response) {
                    ...
                    if (state === "SUCCESS") {
                        ...
                        if (accInfo.DocumentSubmittedDateTime__c) {
                            component.set('v.DisplayAdditionalSection', true);
                        }
                        if (accInfo.InterestedProductTypeAsCustomerTOP__c) {
                        ...
                        console.log('AccountNumber : ' + accInfo.Customer__r.AccountNumber__c);
                        if (accInfo.InterestedProductTypeAsSupplierTOP__c) {
                        ...
                        console.log('accInfo :' + accInfo.RecordType.DeveloperName.includes('Edit'));
                        console.log('RecordType :' + accInfo.RecordType.DeveloperName);
    ...
    removeDeletedRow: function (component, event, helper) {
        ...
        console.log('itemList removed:' + itemList);
    ...
    removeDeletedRowDestination: function (component, event, helper) {
        ...
        itemList.splice(index, 1);
        console.log('itemList destination removed:' + itemList);
        ...
        try {
            ...
            if (validateShareHolder) {
                ...
                if (component.get("v.ObjectType") == 'CTRRequestFormHeader__c') {
                    ...
                    if (!fields.Name) {
                        console.log('account nam missing');
                        fields.Name = fields.CompanyNameENF__c;
                    }


                    var custproduct = component.find("InterestedProductTypeAsCustomerTOP__c").get("v.value");
                    var supplproduct = component.find("InterestedProductTypeAsSupplierTOP__c").get("v.value");
                        ...
                        action.setCallback(this, function (response) {
                            ...
                            if (state === "SUCCESS") {
                                ...
                                if (listofvalue.AccountId) {
                                    ...
                                    toastEvent.setParams({
                                        "title": "Error!",
                                        "message": listofvalue.newRequestHeaderId,
                                        "type": "error"
                                    });
                                    toastEvent.fire();
                                }
    ...
    handleSuccess: function (component, event, helper) {
        ...
        console.log('accId--' + component.get("v.accId"), component.get('v.isAccount'));
        component.get('v.isAccount');
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                console.log('success', reqItem, component.get('v.recordTypeName'));
    ...
    handleInterestProductSupplierChange: function (component, event, helper) {
        ...
        if (supplproduct) {
            ...
            if (supplproduct.includes("Other Products")) {
                ...
                component.set('v.isSupplierOtherProducts', false);
            }
            component.set('v.isSupplierProductSelected', true);
        }
        else {
    ...
    handleChangeYesNo: function (component, event, helper) {
        ...
        var Name = event.getSource().get('v.id');
        //var name2 = 
