({
	...
	handleLoad: function (component, event, helper) {
		...
		if (!(String(userStatus).indexOf("WCCL") > -1)) {
			component.set("v.form.User_Status__c", userStatus + " WCCL");
		}
		component.set("v.form.Last_User_Action__c", "WCCL");
		if (extNo > 1) {
			component.set("v.form.Last_User_Action__c", "WCCL2");
		}
	},
	...
	showModal: function (component, event, helper) {
		if (event.getParam('modal') === 'THOR_WorkClearanceCloseModal') {
